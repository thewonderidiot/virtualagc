...
## Filename:	EXTENDED_VERBS.agc.agc
...
VERB69		TC	VERB69		# VB69 CAUSE RESTART
		...
		TC	V79		# VB79 START BARBECUE MODE ROUTINE (R64)
...
# RETURN TO L+1 IF NOUN 20 - TO L+2 IF NOUN 91.
...
#
#	1.	REQUIRE POO OR POO- OR TURN ON OPERATOR ERROR.
...
GOTOR23		TC	UPFLAG		# SET R23FLG
		ADRES	R23FLG		# BIT 9 FLAG 1
		TC	TESTXACT
		CA	FLAGWRD0	# VB 57	UNNACCEPTABLE UNLESS BOTH
...
# VERB 79  START BARBECUE MODE ROUTINE (R64)
