...
V82GOFF		EXIT			# ALLOW ASTRONAUT TO SELECT VEHICLE
		...
		RELINT
V82GOFLP	CAF	ZERO		# MAJOR RECYCLE LOOP ENTRY
...
ISTIMEOK	TC	INTPRET
		DLOAD	BZE
			DSPTEMX
			GETNOW
STRTDEC1	STORE	TDEC1		# TIME FOR STATE VECTOR UPDATE.
		STORE	TSTART82	# TIME FOR INTERNAL USE.
		EXIT
		CS	OPTION82	# 1 FOR THIS VEHICLE, NOT 1 FOR OTHER
		AD	ONE
		EXTEND
		BZF	THISSHIP
OTHSHIP		TC	INTPRET
...
V82GON		EXIT			# AVERAGE G ON.  USE CURRENT STATE VECTOR
		...
		TC	CHANG1		# IS DONE.  NOTE:  V82GON1 (PRIO7, FINDVAC
					...
					# NOVAC JOB).
V82REDSP	CAF	V16N44X		# MONITOR HAPO, HPER, TFF
		TC	BANKCALL
		CADR	GOXDSPF
