...
V97T		TC	2PHSCHNG
		...
		OCT	00674		# A, 4.67 = V97TJOB (-0 CS), TBASE OLD
...
V97TTASK	CAF	3MDOT		# 3 SECONDS OF MDOT (2-4 SEC ENGFAIL
		...
		TC	PHASCHNG
		OCT	40714		# A, 4.71 = V97TRCS (250 CS), TBASE NOW
...
ENDV97T		TCF	TASKOVER
		...
		EBANK=	V97VCNTR
V97P		TC	PHASCHNG
		OCT	00734		# A, 4.73 = V97PJOB (-0 CS), TBASE OLD
...
V97PTASK	CAE	V97VCNTR	# GET MASS UPDATES (TVCEXEC) GOING AGAIN
		...
		ADRES	STEERSW
		TC	PHASCHNG
		OCT	40134		# A, 4.13 = R40ENABL (200 CS), TBASE NOW
...
ENDV97P		TCF	TASKOVER
		...
		EBANK=	WHOCARES
V97E		TC	PHASCHNG
		OCT	00534		# A, 4.53 = V97EJOB (-0 CS), TBASE OLD
...
V97ETASK	CS	OCT24		# FORCE R1 OF V06N40 TO READ  59X59
		...
		TS	MASSTMP		#	FAILED....COPYCYCLE FOR MASSBACK
		TC	PHASCHNG
		OCT	40754		# A, 4.75 = SPSOFF97 (-0 CS), TBASE NOW
SPSOFF97	TCR	SPSOFF
		TC	PHASCHNG
