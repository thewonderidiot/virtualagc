...
V97T		TC	2PHSCHNG
		...
		OCT	00674		# A, 4.67 = V97TTASK (-0 CS), TBASE NOW ## FIXME
		CAF	ZERO		# DISABLE CLOCKJOB
		TS	NVWORD1
		CAF	BIT1
		TC	TWIDDLE
		...
		EBANK=	CSMMASS
V97TTASK	CAF	3MDOT		# 3 SECONDS OF MDOT (2-4 SEC ENGFAIL
		...
		TC	PHASCHNG
		OCT	40714		# A, 4.71 = V97TRCS (250 CS), TBASE OLD ## FIXME
...
ENDV97T		TCF	TASKOVER
		...
		EBANK=	V97VCNTR
V97P		TC	PHASCHNG
		OCT	00734		# A, 4.73 = V97PTASK (-0 CS), TBASE NOW ## FIXME
...
V97PTASK	CAE	V97VCNTR	# GET MASS UPDATES (TVCEXEC) GOING AGAIN
		...
		ADRES	STEERSW
		TC	PHASCHNG
		OCT	40134		# A, 4.13 = R40ENABL (200 CS), TBASE OLD ## FIXME
...
ENDV97P		TCF	TASKOVER
		...
		EBANK=	WHOCARES
V97E		TC	PHASCHNG
		OCT	00534		# A, 4.53 = V97ETASK (-0 CS), TBASE NOW ## FIXME
		CAF	V06N40		# REDISPLAY V06N40
		TS	NVWORD1
		CAF	BIT1
		TC	WAITLIST
...
V97ETASK	CS	OCT24		# FORCE R1 OF V06N40 TO READ  59X59
		...
		TS	MASSTMP		#	FAILED....COPYCYCLE FOR MASSBACK
		TC	PHASCHNG
		OCT	40754		# A, 4.75 = SPSOFF97 (-0 CS), TBASE OLD ## FIXME
SPSOFF97	TCR	SPSOFF
		TC	PHASCHNG
