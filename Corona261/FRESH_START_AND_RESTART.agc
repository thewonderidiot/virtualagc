...
## Page 141
		...
		CAF	SWINIT		# INITIALIZE SWITCH BIT AREA ON FRESH
		TS	STATE		# START ONLY.
		CAF	SWINIT +1
		TS	STATE +1
		CAF	SWINIT +2
		...
		CS	OLDERR		# SEE IF CURTAINS CALLED FRESH START.
		MASK	BIT5
		CCS	A
		TC	STARTSW
...
STARTSW		TC	ENDFRESH
ESTART		CAF	PRIO25		# FIRE UP INITIALIZATION JOB.
		TC	FINDVAC
		CADR	BEGIN501
		
		TC	ENDFRESH
		
KENABLE		CAF	OCT50		# COMMANDED FINE ALIGN.
		TS	WASKSET
...
THATSALL	TS	SFAIL		# CURTAINS - FLUSH MISSION PROGRAM.
		INHINT
		CAF	BITS4&5		# DO FRESH START AND PROGRAM ALARM.
		TC	SLAP2
...
## 202 R: Removed ERESTORE handling.
GOPROG		CAF	DVMONMSK	# SHOULD BE SYS FLAG FOR ENGINE ON.
		MASK	FLAGWRD1
...
ENEMA		INHINT			# A STRANGE INSTRUCTION TO BEAR THIS NAME.
		...
		CS	ZERO		# ALL 7 IN SFAIL DENOTES PROGRAMMED REDO.
		TS	SFAIL
...
GOCADR		CADR	MIDGO		# GROUP 1 RESTARTS.
