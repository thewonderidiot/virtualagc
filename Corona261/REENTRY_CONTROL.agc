...
INITROLL	DMOVE	0
		...
		TEST	2		# IF D-.05 G NEG, GO TO LIMITL/D
...
# RDOT = VRCONT.
		...
		SWITCH	2		# IF V-VFINAL NEG, GO TO FINAL PHASE
		DSU	BPL
		EXIT
			INRLSW
			V
...
PREHUNT		TC	ALARM		# SET HUNTSW1 AND HIND SWITCHES
		OCT	00140
...
## Page 721
		...
		DSQ	DDV
			V1
			V
			2C1HSLAD	# (V1-V)SQ/(2 C1 HS/LAD) INTO PD
...
GETUNB		RTB	3		# RESET PUSH COUNTER.
		...
		DMOVE	0		# SAVE ROLLC SO THAT IT CANNOT CHANGE
