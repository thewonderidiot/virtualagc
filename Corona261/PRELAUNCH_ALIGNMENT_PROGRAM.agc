...
PTORQUE1	CAF	ZERO		# INITIALIZE TORQUING REGISTERS AND RESET
		XCH	THETAX
		AD	INFLANG +1
		TS	GYROANG +1
		CAF	ZERO
...
#	PRELAUNCH TERMINATION.
		...
		TC	FREEDSP
PRELEXIT	TC	BANKCALL	# RETURN IMU TO MANUAL CONTROL.
		CADR	IMUFINIS
...
CHKOPT		TC	GRABDSP
		...
		ITC	0
			MAKEXSM		# COMPUTE DESIRED SM ORIENTAYION IN REC
