...
## 202 ??? Removed 76JUMPTO reference.
		TC	76UPDATE	# VERB 76 IS STATE VECTOR UPDATE
		TC	POSTJUMP	# VERB 77 IS L/O TIME UPDATE
		CADR	ABORTRPT
## 202 ???: Removed 76JUMPTO, 71JUMPTO and ABRTJPTO.
...
# AS IN1 CHANGES. IT DOES THIS BY CONTIUOUS WAITLIST REQUESTS UNTIL A
...
# BIT1 OF IN1LOSAV = LAST VALUE OF BIT1 OF IN1
...
75FN4		TC	CHECKMM		# NO MODE 13 PLANNED.
		OCT	14
		TC	MALAPROP
...
#	FUNCTION 3 - DO LIFT-OFF IF IN MAJOR MODE 04
...
## 202 F/BB: The update program was completely rewritten for Solarium.
# THE FOLLOWING PROGRAM IMPLEMENTS MAJOR MODE 27 OF FLIGHT 202 - STATE VECTOR UPDATE.

76UPDATE	TC	CHECKMM		# IS THIS P24
		OCT	24
		TC	XACTALM		# NO
		TC	FLAG1DWN
		OCT	20000
		CAF	LDNLST2		# SET UP UPDATE DOWNLIST
		TS	DNLSTADR
		TC	NEWMODE
		OCT	27
		TC	GRABDSP
...
OHWELL		CS	-UPADR
		...
		CADR	FLASHON
		CAF	PERFNV
		TC	NVSUB		# DISPLAY V50N00
		TC	PRENVBSY
		TC	ENDIDLE
		TC	NEXTCHGE
		TC	NEXTCHGE
		TC	FLAG1UP		# SET UPDATFLG
		OCT	20000
ENDUPDAT	TC	CHECKMM		# COMES HERE ON V34E
		OCT	27		# IS IT STILL P27
		TC	XVBOUT		# NO, DO NOT CHANGE PRESENT PROGRAM
		TC	NEWMODE		# YES, RESTORE P24
		OCT	24
XVBOUT		TC	FREEDSP
		TC	ENDOFJOB
REDO5.20	TC	NEWMODE
...
NEXTCHGE	CAF	L-UPADR		# YES, SET UP FOR OCTAL ID IF NEEDED
		...
		TC	NEXTCHGE	# V33E, UPDATE VERIFIED
