...
ERASCHK		CAF	CONERAS2	# 01774
		TS	1777
## 202 ??? Restored Sunrise 69-style ERASLOOP.
ERASLOOP	CS	1777
		RELINT
		CS	0000
		INHINT
...
# SKEEP1 HOLDS SUM
# SKEEP2 HOLDS PRESENT CONTENTS OF ADDRESS IN ROPCHEK AND SHOWSUM ROUTINES
...
SDISPLAY	INDEX	SKEEP4
		...
		TC	DATACALL
		TC	+3
FXFXWORD	INDEX	SKEEP3		# GETS FXFX BUGGER WORD
		CAF	0000
...
## 202 R???: Added TS BANKREG to start of SMODECHK.
		TS	BANKREG
SMODECHK	CCS	NEWJOB		# SEE IF ITS TIME FOR A CHANGE.
## 202 R???: Changed from TC DUMEXIT
		TC	UNK3011
...
DUMMYJOB	CAF	SMODECON	# ENTER AT SMODECHK IF THERE IS A
		TS	QADRS		# FRESH START OR A GOJAM
		TC	DUMYJOB
SMODECON	ADRES	ADVAN +2	## FIXME
...
# ENGINE-ON PROGRAM	FOLLOWING A +XXX.XX SECOND DELAY OF LESS THAN 2 MINUTES, ENGINE WILL REMAIN ON FOR +XXX.XX
