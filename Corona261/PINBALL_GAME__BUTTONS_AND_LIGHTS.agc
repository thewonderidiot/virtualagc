...
##		2021-05-30 ABS	Added ENDVBFAN symbol present in scans.
...
# IDAD1TEM	ERASE			TEMP FOR INDIR ADRES TABLE ENTRY(MIXNN)
#					MUST = IDAD2TEM-1, = IDAD3TEM-2.
# IDAD2TEM	ERASE			TEMP FOR INDIR ADRES TABLE ENTRY(MIXNN)
...
CHARIN		TC	DSPLOCK1	# BLOCK DISPLAY SYST BUT SAVE OLD
...
## 202 ???: Changed from OCT32 to LOW5
ABORTCAL	CAF	LOW5
...
## 202 Y3: Removed consecutive +/- check.
		CS	R1D1
		TC	SGNTST1
		CS	R2D1
		TC	SGNTST1
...
ERROR		CS	BIT4		# RESTORE ORIGINAL C(DSPLOCK) BIT4 OF
		...
		MASK	DSPLOCK		# DSPLOCK UNCHANGED.
		AD	21/22REG
		TS	DSPLOCK
...
CLEAR		CCS	DSPCOUNT
		...
		TC	+2
		AD	ONE
## 202 Y2: Removed DSPCOUNT-related fix.
		TS	DSPCOUNT
		TC	GETINREL
		CCS	CLPASS
		TC	CLPASHI		# +
...
## 202 V: Restored bit 13 of WASOPSET check.
OPDEGOUT	CAF	BIT13
		MASK	WASOPSET
		CCS	A
		TC	+3
...
DEGINSF2	TC	BANKCALL	# LEFT 2
		CADR	SL1 +3
		TC	TESTOFUF
		TC	BANKCALL	# RETURNS IF NO OF/UF
		CADR	SL1 +3		# LEFT 3
		CCS	MPAC
...
MONIT1		TS	MPAC +1		# TEMP STORAGE
		...
		TC	CCSHOLE
		TC	DSPLOCK0	# GRABLOCK=2. +0 INTO DSPLOCK (BIT4 OF
					# STATE) AND LEAVE KEY RELEASE LIGHT ALONE
		INHINT
		CCS	MONSAVE
...
GTSFIN		INDEX	SFTEMP2		# SF CONUM ARRIVES IN SFTEMP2.
		CAF	SFINTAB1
		TS	SFTEMP1
		INDEX	SFTEMP2
		CAF	SFINTAB2
...
NNTYPTAB	OCT	00000		# 00 NOT IN USE
		...
		OCT	00252		# 32 3COMP  TIME WEEKS
		OCT	00252		# 33 3COMP  TIME WEEKS
		OCT	00350		# 34 3COMP  POSITION
...
IDADDTAB	CADR	OPTX 	+04000	# 01	   DEGREES		52
		...
		CADR	DSPTEM1 +04000	# 02	   DEGREES		627
...
## 202 ???: Restored N62
		CADR	CDUZ	+04000	# 06	   DEGREES		51
		CADR	TIME2	+10000	# 06	   SEC			35
