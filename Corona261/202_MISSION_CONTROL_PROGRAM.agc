...
## 202 C: Reimplemented old liftoff program. Many many changes below.
		CS	TLIFTOFF +1
		TS	TBASE2
		TS	TBASE3
		TS	TBASE4
...
## 202 ???: Removed resetting of UPDAT FLAG
...
## 202 ???: Added FLAG1UP call and reordered the following calls. FIXME: Kill REDO4.21?
		TC	FLAG1UP
		OCT	00400
...
## 202 ???: Removed call to SETBRNSW
SETABORT	TC	PHASCHNG
		OCT	02004
		
		INHINT
		CAF	0.8SEC		# START ENGINE IN 4.3 SECS FIXME
		TC	WAITLIST
		CADR	ATTCNOFF
		RELINT
...
## 202 ???: Restored original ABORTRPT implementation
...
## 202 ???: Removed all logic from the end of the task.
		TC	TASKOVER
...
## 202 ???: Removed RELAYOFF for SCX +X TRANS DISCRETE
...
## 202 ???: Replaced lots of logic with the following two lines.
		CAF	ABORTLOC
		TS	VRCADR
...
## 202 ???: Moved constants to end of bank
## Page 576

## 202 ???: Moved to bank 30.
...
10SEC		DEC	1000
## 202 FIXME: Moved -310SEC to end of bank
...
## 202 ???: Removed clearing of DELV
		
REDO5.3		TC	INTPRET

## 202 ???: Removed 501UPCHK
...
## 202 FIXME: Lots of logic deleted.
		
# 202 FIXME: Added ITC to beginning.
TFFTEST		ITC
			TFFTEST1 ## FIXME
...
## 202 ???: Removed setting of VIGNITION to VIN
...
## 202 --------------- EVERYTHING BELOW IS UNALIGNED AND MOSTLY MATCHES SOLARIUM ------------------------
...
## 202 ???: Added the following equation.
		TEST	2
		NOLOD	DMP
		DAD
			SPS2FLAG
...
## 202 ???: Removed TEST on SPS2FLAG to invert XSC
		VXSC	1
		VAD
			ZNB
			SIN33
...
DRIVECDU	VXSC	1		# FORM INCREMENTAL MANEUVER VECTOR
		...
		TEST	0		# TEST IF DOMAN FLAG SET
			DOMANFLG
			UNK6625		# IT IS NOT. GET NEXT MANEUVER
		
		EXIT	0
		TC	ENDOFJOB

## 202 ???: Restored following logic.
UNK6625		TEST	0
			SPS1FLAG
			NEXTMAN
		EXIT	0
...
## 202 K: Replaced cold soak code with vertical erection code
VERTINIT	TC	NEWMODE		# SET MAJOR MODE TO MANEUVER TO VERTICAL ERECTION
		OCT	00021
		
		TC	INTPRET
		
## 202 ???: Replaced math to calculate XSCD, YSCD, ZSCD
		VMOVE	1
		COMP
			REFRCV ## FIXME
		STORE	XSCD
...
## 202 K: Replaced with VERTIJOB. FIXME: Scrub labels in this code
VERTIJOB	TC	INTPRET
...
UNK7114		2DEC	.1
UNK7116		2DEC	.1
VERTIME		2DEC	203717	## FIXME

## Page 609

# UPTASK AND UPJOB OCCUR 120 SECS BEFORE PLUSX2 AND INCORPORATE STATE VECTOR UPDATES VIA VERB 76

## 202 ???: Removed FDAIOFF2 call with PLUSX1 (FIXME NAME)
UPTASK		CAF	18SEC
		TC	WAITLIST
		CADR	PLUSX1
		
## 202 ???: Removed RELAYON to set FDAI align
...
## 202 ???: Removed a significant chunk of code.
...
## 202 ??? : Removed most logic from NOSTATE.
NOSTATE		EXIT	0
...
# 202 ???: Replaced all logic down to SHUTDOWN with PLUSX1.
...
## 202 ???: Added first equation in GOGETUNB.
GOGETUNB	ABVAL	2
		DSU	BMN
		LODON	DMOVE
			VN
			...
			-	## FIXME 30,7211
		STORE	ROLLC	## FIXME
		ITC	0		# COMPUTE DESIRED NAV BASE COORDS.
			GETUNB
...
AVGON		CAF	PIPCAD24	# CLEAR AND EXCHANGE PIPAS TO SAVE DELV
		...
		OCT	40000		# (REMOVE DRIFT FLAG)
## Page 621
## 202 ???: Removed STATEUP reference
		TC	ALARM		# SET BIAS FLAG
		OCT	04000
...
2SEC24		DEC	200
90SEC24		DEC	9000
LOCSPS1		CADR	202SPS1
PIPCAD24	CADR	PIPASR



## 202 ???: FIXME Temporary removal of Solarium MODE32 and PLUSX2 definitions
...
# ## 202 ???: Removed STATEDWN reference
# 		TC	ALARM		# REMOVE BIAS FLAG
# 		OCT	04000
# ## Page 623
...
## 202 ???: Removed STATEUP and STATEDWN
...
THIRTY		DEC	30
30DEC		EQUALS	THIRTY
## 202 ???: Removed THIRTY1 and THIRTY2
FORTY		DEC	40
40DEC		EQUALS	FORTY
FIFTY		DEC	50
50DEC		EQUALS	FIFTY
