...
ABORTRPT	TC	ALARM  		# COME HERE ON RECEIPT OF UPLINK ABORT
...
## 202 FIXME: Temporary (?) removal of CGTASK to fix bank 14
#		BANK	14
...
## 202 ???: Removed STATEUP reference
		TC	ALARM		# ALL O.K., SO SET TFF2 FLAG TO ENABLE
		OCT	10000		#   (TFF - TFFMIN) CALCULATIONS FOR SPS2
		TC	NOMCASE		#   IGNITION SEQUENCE
...
## 202 ???: Removed STATEDWN reference
		TC	ALARM		# RESET TFF2 FLAG SO THAT SPS2 IGNITION IS
...
SPS2NOW		EXIT	0
		...
		CS	ONE		# LET ENEMA KILL COLD SOAK MANUEVER
		TC	NEWPHASE
## Page 584
		OCT	00002
