...
ZEROOCTR	CAF	ZERO
		TS	OPTX
## 202 V: Added back in check of bit 13 of WASOPSET.
		CAF	BIT13
		MASK	WASOPSET
		CCS	A
...
## 202 Y1: Removed double entry logic.
...
## 202 ???: Removed block-endpulse reset.
...
## 202 ???: Restored Sunrise order of masking DSPTAB +13D.
		XCH	DSPTAB +13D
		MASK	LOW11
		TS	DSPTAB +13D
		AD	RELTAB11 +2
...
## 202 ???: Restored Sunrise order of masking DSPTAB +11D.
		XCH	DSPTAB +11D
		MASK	LOW11
		TS	DSPTAB +11D
		AD	RELTAB11
...
## 202 ???: Restored Sunrise order of masking DSPTAB +12D.
		XCH	DSPTAB +12D
		MASK	LOW11
		TS	DSPTAB +12D
		AD	RELTAB11 +1
