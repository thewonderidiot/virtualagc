...
OPONLY          TC              OPONLY1                 # CHANGE FOR MODULE REMAKE
...
GLOCKCHK        AD              -70DEGS
                ...
                TCF             GLOCKCK1                # CHANGE FOR MODULE REMAKE
                TCF             SETGLOCK
...
GLOCKCK1        AD              -15DEGS                         # SEE IF ABS(MGA) GREATER THAN 85 DEGS.
                EXTEND
                BZMF            +4
...
OPONLY1         CAF             BIT4
                ...
                CCS             A
                TCF             C33TEST
                CAF             IMUSEFLG                # IF OPERATE ON ONLY, ZERO THE COUNTERS
                TCF             OPONLY          +1
