...
## Mod history:	2009-09-02 JL	Adapted from corresponding Comanche 055 file.
##		2009-09-16 JL	Fixed line comment alignment in top section of file.
...
INTPRET		RELINT
 ...
 +3		CA	BBANK		# INTERPRETIVE BRANCHES FINISH HERE.
		TS	BANKSET
...
# AT THE END OF MOST INSTRUCTIONS, CONTROL IS GIVEN TO DANZIG TO DISPATCH THE NEXT OPERATION.
 ...
 +2		TS	MPAC +2		# AND DECLARE DP MODE
...
BUFAGREE	TS	MPAC +2		# ZERO LOW-ORDER WORD
...
SQRTABRT	TC	POODOO
		OCT	21302		# SQRT CALLED WITH NEGATIVE ARGUMENT
...
TEST		MASK	SWBIT
 ...
 +11D		NOOP			# CANNOT GET HERE
SWSKIP		INCR	LOC

 +13D		TCF	DANZIG		# 11 - NOOP.

B3TOB4		EQUALS	COREINC
SW/		EQUALS	SWITCHES
