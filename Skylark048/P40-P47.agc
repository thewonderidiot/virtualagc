...
SETMINDB	INDEX	WHICHDAP
		...
		EBANK=	DAPDATR1
 -1		INHINT
SETMAXDB	INDEX	WHICHDAP
		TCF	+1
		TCF	+2
		TCF	SETMINDB +3

		CA	MAXDB		# ROUTINE FOR SETTING
...
S40.130		BDSU	PUSH		# 00D = MAG(VGTIG) @ B+7 M/CS, ADJUSTED 
 ...
 +1		DLOAD	DDV		# ENTRY POINT IF ULLAGE OFF
		...
		SL	BOV
			10D		# SCALING
			S40.136		# LARGE VG : STEERING BURN INDICATED
		DSU	DMP
		...
		DSU	BPL
			500B-14		# 5SEC @ B+14CS
			S40.136		# STEERING BURN INDICATED, DELTAT > 6 SEC
		DLOAD	BPL
			02D		# (DELTAT-1SEC) @ B+14CS, FIMP16 SLOPE
			S40.134		# 1<DELTAT<6SEC, SO FIMP16 SLOPE USE IS OK
...
U24,3661	CAF	HISLOPE
		EXTEND
		MP	VELSS
		AD	HIBIAS

U24,3665	TS	RUPTREG1
		CA	VELSS
		EXTEND
		MP	HALF
		EXTEND
