...
REDAP		CA	FLAGWRD3
		...
		TC	IBNKCALL	# DECODE DAPDATR1, DAPDATR2 FOR DEADBANDS
...
NO.T5VAR	DEC	37		# NO. OF LOCATIONS TO BE ZEROED
					# MINUS 2...MUST BE ODD
...
MERUPDAT	INDEX	WHICHDAP
		TCF	+1
		TCF	+2
		TCF	U21,2771

		INDEX	Q		# MERRORX=MERRORX+MEASURED CHANGE IN ANGLE
		CS	MANTABLE -1	# -COMMANDED CHANGE IN ANGLE
U21,2747	EXTEND			# THE ADDITION OF MEASURED CHANGE IN ANGLE
...
OCT00300	OCT	00300		# YAW FORCED FIRING MASK	MUST BE
					...
					#			      FOR INDEXING
MANROT		OCT	77
OCT16000	=	PRIO16		# RATE DAMPING FLAGS MASK
...
U21,3146	TC	IBNKCALL	## FIXME IS THIS THE BEST PLACEMENT
		CADR	FDAIDSP2
