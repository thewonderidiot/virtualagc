...
WASIU		TCF	ATTDISP		# NO - CONTINUE
WASINIT		TCF	ATRESET		# YES - REINITIALIZE NEEDLER (2ND PASS)
WASCMC		TCF	ATRESET		# YES - REINITIALIZE NEEDLER
...
ATTDISP		CS	RPSTART		# PITCH/ROLL START TIME
		...
		EXTEND
		BZMF	+2
POSTPOLY	TC	NOPOLY		# GO TO ATTITUDE HOLD
		CA	TIME2
		EXTEND
		BZMF	+2
...
RLTST		CA	MPAC		# DETERMINE IF ROLLOUT
		...
		ZL			# ROLLOUT COMPLETED
		CAF	ZERO		# ZERO OUT ROLL CONTRIBUTION
		DXCH	MPAC
		TC	DANZIG
...
SATSTICK	LXCH	BANKRUPT
		...
		CADR	NEEDLER	
STICKOUT	TCF	RESUME		# END OF SATURN STICK CONTROL
