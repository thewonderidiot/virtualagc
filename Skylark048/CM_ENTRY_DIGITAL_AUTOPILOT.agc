...
READGYMB	CA	TEN		# KEEP RESTART DT GOING RELATIVE TO
		...
		CA	NOIMUDAP	# CHECK FOR FINE ALIGN MODE OF CDU.
		MASK	IMODES33	# (PROTECT AOG/PIP ETC AS WELL AS
		EXTEND			# GIMBAL DIFFERENCES)
		BZF	READGYM1	# OK

		CS	GYMDIBIT	# NOT IN FINE ALIGN, SO IDLE
...
NOTYET		CA	.5SEC
 ...
 +4		CA	GMDIFBIT	# GAMDIFSW = 94D BIT11   INITLY=0
...
NOGAMDUT	CA	CMARMBIT	# CMDAPARM = 93D BIT 12
		MASK	CM/FLAGS
		EXTEND
...
# 	START YAW AUTOPILOT HERE .  RATE DAMPING WITH ENFORCED COORDINATED ROLL MANEUVER.
		...
		CA	.05GBIT		# .05GSW = 102D BIT3  SW=0, LESS .05G
...
# DOES SGN(-VT) (VT/180) (VT/180) (180/(4 A1 TT COSALFA)) + X/360 + SGN(X) / 2		OVFL ?
		...
		TCF	+2
		CS	POS1/2
		AD	LCX/360		# IS LCX/360 LESS THAN 180 DEG  $
		AD	L
		TS	L
...
# ENTER WITH THREE TIME INTERVALS AND THE CORRESPONDING JET CODE INDEXES IN ERASEABLE LOCS TON1, TOFF, TON2, JNDX
...
JETACTN		CA	NUJET		# COME HERE WHEN DESIRED JET CODE IS KNOWN
 +1		EXTEND			# NO NEED TO SAVE OLD CODES
...
JETCALL		CAF	CM/DSBIT	# CM/DSTBY = BIT2 103D
...
CM/FDAI		CS	PHIDOT		# INTEGRATE ROLL ERROR 'TWEEN 2SEC UPDATES
		...
		EXTEND
		MP	HALF
 -1		ADS	PAXERR1		# ROLL ERROR/360.	OVFL OK.
