...
# 			BIT 5 FLAG 0
NC12FLG		=	010D		# P32 (NC 2)		P31 (NC 2)
...
# 			BIT 11 FLAG 3
501**FLG	=	49D		# THE 501 ALARM HAS	THE 501 ALARM HAS
					# BEEN SET TO INDI-	NOT YET BEEN SET.
...
CSMPOS		ERASE	+53D		# I(6)TMP	## FIXME SHRUNK FROM +55
...
MARKTIME	EQUALS	DELTAX +18D	# B(2) TEMP MUST PRECEDE VTEMP FOR GENTRAN
...
## FIXME NEW STUFF
PMATRIX		ERASE	+17D
VHF.B		EQUALS	PMATRIX
VHF.Z		EQUALS	PMATRIX +6
VHF.OMEG	EQUALS	PMATRIX +12D
...
HAPOX		EQUALS	TSTART82 +2	# I(2) DSP NOUN 44 FIXME
...
UE4,1745	EQUALS	NPASS +1	# I(1)
FIXTEMP		EQUALS	UE4,1745 +1	# I(2)
R27END		EQUALS	FIXTEMP +2	# I(1)
VECLOS		EQUALS	R27END +1	# I(6)


## FIXME P31-P33 -- DETERMINE BEST ORDER FOR OVERLAYS
VAH1		EQUALS	VECLOS +6	# I(6)
VPTPI		EQUALS	VAH1
URPD		EQUALS	VAH1
RAS		EQUALS	VAH1 +6		# I(6)
COSE		EQUALS	RAS
ITERCNT		EQUALS	COSE +2
UE4,1771	EQUALS	ITERCNT +2


## FIXME DOCKED DAP
1/2ALPHA	EQUALS	RAS +6
...
END-W		EQUALS	W +156D		# **NEXT AVAILABLE LOC AFTER W MATRIX** FIXME
...
CULTRIX		EQUALS	VSUN		# VSUN, VEARTH, SAX	FIXME DOUBLE CHECK ORDER
...
VGNSR		EQUALS	AM1 +6
URJ		EQUALS	VGNSR +6
HALFREVS	EQUALS	URJ +6
UE5,1633	EQUALS	HALFREVS +1
...
COUNT3MK	EQUALS	UE5,1552 +1	# I(1)
...
## FIXME DOCKED DAP
SLOPE2		ERASE	+1		# B(2)
WLH/SLOP	ERASE	+1		# B(2)
WL-H/SLP	ERASE	+1		# B(2)
ECP		ERASE			# B(1)
ECYW		ERASE			# B(1)
ALPHAP		ERASE			# B(1)
ALPHAYW		ERASE			# B(1)
...
TRCOMPAC	EQUALS	TAU2 +1		# B(1) FIXME
TRCOMPBD	EQUALS	TRCOMPAC +1	# B(1) FIXME
...
## FIXME NEW OWS DAP
T5TEMP2		EQUALS	RACFAIL
NEXT6INT	EQUALS	T5TEMP2 +1
5WORD		EQUALS	NEXT6INT +1
6WORD		EQUALS	5WORD +1
TAUZ		EQUALS	RMANNDX
TAUY		EQUALS	TAUZ +1
...
THETTEMP	EQUALS	POINTVSM +6	# I(3) FIXME
...
## FIXME NEW
SBDELT		EQUALS	END-DELV	# I(1)PL   FOR P40 S
...
VPRED		EQUALS	TTE2 +2		# DSP NOUN 60 FOR P61,   ,62,63. FIXME CHANGED
...
EOP		EQUALS	CF +2
DVOC		EQUALS	EOP +2
DELHTMP		EQUALS	DVOC +2
RATEMP		EQUALS	DELHTMP +2
RAH2		EQUALS	RATEMP +2
DVDSP1		EQUALS	RAH2 +6
DVDSP2		EQUALS	DVDSP1 +2
VAH2		EQUALS	DVDSP2 +2
PSHFT1		EQUALS	VAH2 +6
PSHFT2		EQUALS	PSHFT1 +1
...
## FIXME SHORT BURN LOGIC
PIPAPIX		EQUALS	DELEL
PIPAPIY		EQUALS	PIPAPIX +1
PIPAPIZ		EQUALS	PIPAPIY +1
SBVGMAG		EQUALS	PIPAPIZ +1
DVTAIL		EQUALS	SBVGMAG +1
TDELTA		EQUALS	DVTAIL +1
TZEROED		EQUALS	TDELTA +1
PASTT		EQUALS	TZEROED +1
PASTDV		EQUALS	PASTT +1
PREST		EQUALS	PASTDV +1
PRESDV		EQUALS	PREST +1
UE7,1464	EQUALS	PRESDV +1
UE7,1465	EQUALS	UE7,1464 +1
UE7,1466	EQUALS	UE7,1465 +1
VRSS-SL		EQUALS	UE7,1466 +1
UE7,1470	EQUALS	VRSS-SL +1
...
## FIXME NEW P55
TRKAZ		EQUALS	RACT3
TRKEL		EQUALS	TRKAZ +1
TRKAZOCT	EQUALS	TRKEL +1
...
## FIXME NEW R26
VHF.W		EQUALS	LASTTIG +2
SVEC		EQUALS	VHF.W +18D
VSAV		EQUALS	SVEC +8D
...
## FIXME P31-P32
NC1TIG		EQUALS	VGDISP +2
NC2TIG		EQUALS	NC1TIG +2
...
## FIXME NEW R27
WMAT		EQUALS	TPC +2
SVTEM		EQUALS	WMAT +18D
TEMTYM		EQUALS	SVTEM +6
VSAVTEM		EQUALS	TEMTYM +2


## FIXME NEW P50
N23TEMP		EQUALS	RACT3
...
## FIXME KINDA NEW
TN		EQUALS	END-P30S
DELVEET2	EQUALS	TN +2		# I(6) VACT3-VACT2 = DVCDH REF.COORD. FIXME
