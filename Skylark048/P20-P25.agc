...
VHFGOOD		EXTEND
		...
		EBANK=	MRKBUF1
U27,2476	2CADR	LIGHTON
		EBANK=	MRKBUF1
U27,2500	2CADR	RANGERD1
...
THTD123		EXTEND			# TRANSFER OMEGA CONTROL (ANG LOS RATE)
		...
		CS	OCT25
		TS	CH31TEMP
U34,3762	CS	ONE		# NOW DAP VARIABLES LOADED. SET HOLDFLAG.
		TS	HOLDFLAG	# TO -1.
		RELINT
		TC	ASET
...
1/200		DEC	.005
		...
		COUNT*	$$/CRS61
328NM		2DEC	606863.36 B-27	# 327.67 N.M.
