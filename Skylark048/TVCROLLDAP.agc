...
#
#						 2
#		DELOGA = OGAERROR - (DB - OGARATE (1/CONACC)/2) SGN(OGARATE)
#
#
...
# EXAMINE DURATION OF LAST JET FIRING IF JETS NOW ON.
...
DELOGAC		TS	DELOGA		# SCALE B+0 REV, PLUS TO RIGHT OF C-PARAB 
...
# OPERATING POINTS IN REGIONS 6 OR 6')
