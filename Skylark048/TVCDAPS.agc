...
RLIMTEST	TS	TTMP1		# TEST FOR EXCESSIVE CDU RATES (GREATER
		...
		MP	1/RTLIM		#	(USED BY PITCH AND YAW PASSES)
		EXTEND
		BZF	+3
		CAF	ZERO
		TS	TTMP1
...
PINTEGRL	EXTEND			# COMPUTE INTEGRAL OF BODY-AXIS PITCH-RATE
		...
		MP	SINCDUX
		DDOUBL
		DAS	OMEGAYB		# OMEGAYB, SCALED (B-1)/TVCDT  REVS/SEC
...
YINTEGRL	EXTEND			# COMPUTE INTEGRAL OF BODY-AXIS YAW-RATE
		...
		MP	COSCDUX
		DDOUBL
		DAS	OMEGAZB		# OMEGAZB, SCALED (B-1)/TVCDT  REVS/SEC
...
OPTVARK		CS	DAP3 +1		# VARIABLE GAIN PACKAGE
		...
		DXCH	CMDTMP		#		 - SCALED B+0 ASCREV
					...
					# (B+1 ASCREV/REV) ON THE OUTPUT DACS.
