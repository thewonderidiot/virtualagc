...
P21VSAVE	DLOAD			# SAVE CURRENT BASE VECTOR
		...
		SET
			P21FLAG
P21DSP		VLOAD			# GENERATE DISPLAY DATA
			RATT
		STODL	ALPHAV
			TAT
		CLEAR	CALL
...
HOP29DSP	VLOAD	PDDL		# STORE UNIT NORTH(IN PLANETARY COORDS )
		...
		STCALL	DELTLONG	# INITIALIZE LONGITUDE DIFFERENCE TO ZERO
			RP-TO-R		# GET UNIT PLANETARY NORTH IN BASE COORDS.
		...
		STOVL	MUSUBN
			P29BASER
HOPALONG	STODL	ALPHAV		# STORE FOR LAT-LONG
			PASSTIME
