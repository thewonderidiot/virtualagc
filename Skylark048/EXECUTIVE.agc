...
ENDFIND		CA	EXECTEM1	# RETURN TO CALLER AFTER JOB ENTRY
		TS	FBANK		# COMPLETE.
		TCF	Q+2
EXECBANK	EQUALS	BIT11		# THIS IS TRUE IF FINDVAC2 STAYS IN BANK 01
...
OCT40201	OCT	40201		# CANNOT GET HERE
		TCF	+1
...
-CCSPR		-CCS	PRIORITY
		...
		CCS	PRIORITY +48D
		TC	EJ1
PHS2CADR	GENADR	PHSPART2	# CANNOT GET HERE
		TCF	+1

		CCS	PRIORITY +60D
		TC	EJ1
PRT2CADR	GENADR	GETPART2	# CANNOT GET HERE
		TCF	+1

		CCS	PRIORITY +72D
		TC	EJ1
LGCLCADR	GENADR	LONGCALL	# CANNOT GET HERE
		TCF	+1
...
GETCADR		DXCH	LONGCADR	# CANNOT GET HERE
		TC	SUPDXCHZ
		TCF	+2
		TCF	DUMMYJOB
...
EJ2		TS	BUF +1
		CA	Q
		TS	BUF		# FOR LOCATING CCS PRIORITY + X INSTR.
		TCF	Q+2
...
ADVAN		CCS	NEWJOB		# IS A NEWJOB ACTIVE ?
 ...
 +2		CAF	TWO		# NEW JOB ALREADY IN POSITION FOR
