...
LST2FAN		TC	VBZERO		# VB40 ZERO (USED WITH NOUN 20 ONLY).
		...
		TC	DKDISP		# VB44 LOAD DOCKED A/P DATA.
		TC	DKDAPON		# VB45 DOCKED DAP TURN ON.
		...
		TC	DKJTENBL	# VB59 ENABLE JETS INHIBITED BY DOCKED DAP
		...
		TC	R64		# VB64 TRANSFORM OPTICS ANGLES TO TRACKING
...
VERB69		TC	VERB69		# VB 69 CAUSE RESTART
		...
		TCF	V76CALL		# VB76 START R27 IN P20
		TCF	V77CALL		# VB77 KILL R27
...
WMATRXNG	TC	DOWNX		# RESET RENDWFLG
		ADRES	RENDWFLG
