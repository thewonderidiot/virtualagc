...
#	10100			RATE1 (X.XXXX DEG/SEC)		USE ARITH
#	10101			ARC MINUTES (XXXXX. MIN)	USE ARITH
#	10110			VELOCITY5 (XXXX.X FT/SEC)	USE ARITHDP3
#	10111			POSITION10 (XXX.XX NAUT MI)	USE ARITHDP4
#	11000			RATE2 (X.XXXX DEG/SEC)		USE ARITHDP3
#
...
NNADTAB		OCT	00000		# 00 	NOT IN USE
		...
		ECADR	TRKAZ		# 14	STAR TRACKER AZIMUTH
					#	             ELEVATION
		...
		ECADR	TRKAZOCT	# 19	STAR TRACKER AZIMUTH IN 2-WORD OCTAL
					#	FORMAT
		ECADR	CDUX		# 20	ICDU ANGLES
		ECADR	PIPAX		# 21	PIPAS
		ECADR	THETAD		# 22	NEW ICDU ANGLES
		ECADR	THETAD		# 23	NAV BASE TO ATM EULER ANGLES
		...
		ECADR	LASTTIG		# 39	TIG OF LAST MANEUVER
...
# END OF NNADTAB FOR NORMAL NOUNS
		...
		OCT	24052		# 54	RANGE
					#	RANGE RATE
					#	THETA
		OCT	22055		# 55	PERIGEE CODE
					#	ELEVATION ANGLE
		OCT	64060		# 56	VEHICLE RATE
		OCT	24063		# 57	NO. OF HALF REVS
					#	DELTA ALT NCC
					#	DELTA ALT NSR
		OCT	24066		# 58	DELTA V TPI
					#	DELTA V TPF
					#	DELTA TIME (TPI - NOMTPI)
		...
		OCT	24127		# 69	BETA
					#	DL
					#	VL
		OCT	00132		# 70	STAR CODE
		OCT	00135		# 71	STAR CODE
		OCT	24140		# 72	TIME OF R27 OPTIMIZATION
		...
		OCT	64154		# 76	CURRENT R27 RANGE
					#	CURRENT R27 RANGE-RATE
					#	TIME FROM R27 OPTIMIZATION
		OCT	24157		# 77	OPTIMIZED R27 RANGE
					#	OPTIMIZED R27 RANGE-RATE
					#	R27 THETA/PHI
		...
		OCT	24176		# 82	NSR DELTA V (LV)
		OCT	24201		# 83	DELTA V (BODY)
		OCT	24204		# 84	DELTA V NEXT MANEUVER
					#	DELTA ALT - NEXT MANEUVER
					#	DELTA V THIRD MANEUVER
		OCT	24207		# 85	VG (BODY)
		OCT	24212		# 86	DELTA V (LV)
		OCT	04215		# 87	DOCKED DAP FLAG SPECIFICATION
					#	CHANNEL 5 JETS INHIBITED BY DOCKED DAP
					#	CHANNEL 6 JETS INHIBITED BY DOCKED DAP
		OCT	24220		# 88	HALF UNIT SUN OR PLANET VECTOR
		OCT	02223		# 89	MANUAL/AUTO DOCKED DAP MANEUVER RATES
					#	DEAD BAND FOR DOCKED DAP
...
NNTYPTAB	OCT	00000		# 00 		NOT IN USE
		...
		OCT	64705		# 04    3COMP	DEG(180) (NO LOAD, DEC ONLY)
		OCT	02145		# 05	2COMP	DEG(180)
...
# END OF NNTYPTAB FOR NORMAL NOUNS
		...
		OCT	10507		# 54	3COMP	POS5, VEL3, DPDEG(360)
					#		(DEC ONLY)
		OCT	00200		# 55	2COMP	WHOLE, DPDEG(360)
					#		(DEC ONLY)
		OCT	61430		# 56	3COMP	RATE2 FOR EACH
					#		(NO LOAD, DEC ONLY)
		OCT	20400		# 57	3COMP	WHOLE, POS4, POS4
					#		(DEC ONLY)
		OCT	00512		# 58	3COMP	VEL3, VEL3, MIN/SEC
					#		(DEC ONLY)
		...
		OCT	35004		# 69	3COMP	DPDEG(360), DRAG ACCEL, VEL/2VS
					#		(DEC ONLY)
		OCT	00000		# 70	1COMP	OCTAL ONLY
		OCT	00000		# 71	1COMP	OCTAL ONLY
		OCT	00000		# 72	3COMP	HMS (DEC ONLY)
		...
		OCT	00010		# 75	3COMP	POS4, MIN/SEC, MIN/SEC
					# 		(NO LOAD, DEC ONLY)
		OCT	01327		# 76	3COMP	POS10, VEL5, MIN/SEC
					#		(NO LOAD, DEC ONLY)
		OCT	11327		# 77	3COMP	POS10, VEL5, DPDEG(360)
					#		(DEC ONLY)
		...
		OCT	24512		# 83	3COMP	VEL3 FOR EACH
					#		(DEC ONLY)
		OCT	24412		# 84	3COMP	VEL3, POS4, VEL3
					#		(DEC ONLY)
		OCT	24512		# 85	3COMP	VEL3 FOR EACH
					#		(DEC ONLY)
		OCT	22451		# 86	3COMP	VEL2 FOR EACH
					#		(DEC ONLY)
		OCT	0		# 87	3COMP	OCTAL ONLY FOR EACH
		OCT	0		# 88	3COMP	FRAC FOR EACH
					#		(DEC ONLY)
		OCT	00264		# 89	2COMP 	RATE1, DEG(180)
		...
		OCT	00000		# 95	3COMP	HMS (DEC ONLY)
...
SFINTAB		OCT	00006		# WHOLE, DP TIME (SEC)
		...
		2DEC	1.42213543 B-14	# RATE1

		2DEC	4.62962963 B-14	# ARC MINUTES

		2DEC	.3048 E2 B-6	# VELOCITY5

		2DEC	1852 E3 B-23	# POSITION10

		2DEC	.022222222	# RATE2
...
SFOUTAB		OCT	05174		# WHOLE, DP TIME (SEC)
		...
		2DEC	.703167914	# RATE1

		2DEC	.216		# ARC MINUTES

		2DEC*	3.280839896 E-2 B-1* # VELOCITY5

		2DEC*	.5399568 E-6 B20* # POSITION10
...
IDADDTAB	ECADR	TTOGO		# 40	MIN/SEC			M/S
		...
		OCT	0		# 55	SPARE COMPONENT
		ECADR	ADOT		# 56	RATE2			DP3
		ECADR	ADOT +2		# 56	RATE2			DP3
		ECADR	ADOT +4		# 56	RATE2			DP3
		ECADR	HALFREVS	# 57	WHOLE			ARTH
		ECADR	DHNCC		# 57	POS4			DP3
		ECADR	DELH1		# 57	POS4			DP3
		ECADR	DELVTPI		# 58	VEL3			DP3
		ECADR	DELVTPF		# 58	VEL3			DP3
		ECADR	T2TOT3		# 58	MIN/SEC			M/S
		...
		OCT	0		# 70	SPARE COMPONENT
		OCT	0		# 70	SPARE COMPONENT
		ECADR	STARCODE	# 71	OCTAL ONLY		OCT
		OCT	0		# 71	SPARE COMPONENT
		OCT	0		# 71 	SPARE COMPONENT
		ECADR	FIXTIME		# 72 	HMS			HMS
		ECADR	FIXTIME		# 72	HMS			HMS
		ECADR	FIXTIME		# 72	HMS			HMS
		...
		ECADR	SVEC		# 76	POS10			DP4
		ECADR	SVEC +2		# 76	VEL5			DP3
		ECADR	TFO		# 76	MIN/SEC			M/S
		ECADR	OPVEC		# 77	POS10			DP4
		ECADR	OPVEC +2	# 77	VEL5			DP3
		ECADR	PHETA		# 77	DPDEG(360)		DP4
		...
		ECADR	VGNSR		# 82	VEL3			DP3
		ECADR	VGNSR +2	# 82	VEL3			DP3
		ECADR	VGNSR +4	# 82 	VEL3			DP3
		ECADR	DELVIMU		# 83	VEL3			DP3
		ECADR	DELVIMU +2	# 83	VEL3			DP3
		ECADR	DELVIMU +4	# 83	VEL3			DP3
		ECADR	DVDSP1		# 84	VEL3			DP3
		ECADR	DHDSP		# 84	POS4			DP3
		ECADR	DVDSP2		# 84	VEL3			DP3
		...
		ECADR	DAPDATR3	# 87	OCTAL ONLY		OCT
		ECADR	CH5FAIL		# 87	OCTAL ONLY		OCT
		ECADR	CH6FAIL		# 87	OCTAL ONLY		OCT
		ECADR	STARSAV3	# 88	DPFRAC			DPFRAC
		ECADR	STARSAV3 +2	# 88	DPFRAC			DPFRAC
		ECADR	STARSAV3 +4	# 88	DPFRAC			DPFRAC
		ECADR	DKRATE		# 89	RATE1			ARTH
		ECADR	DKDB		# 89	DEG(180)		ARTH
		OCT	0		# 89	SPARE COMPONENT
...
RUTMXTAB	OCT	16351		# 40	M/S, DP3, DP3
		...
		OCT	00503		# 55	ARTH, DP4 
		OCT	16347		# 56	DP3, DP3, DP3
		OCT	16343		# 57	ARTH, DP3, DP3
		OCT	22347		# 58	DP3, DP3, M/S
		...
		OCT	00000		# 70	OCT
		OCT	00000		# 71	OCT
		OCT	20410		# 72	HMS, HMS, HMS
		OCT	24507		# 73	DP3, DP4, DP4
		OCT	12512		# 74	DP4, DP4, DP2
		OCT	22447		# 75	DP3, M/S, M/S
		OCT	22352		# 76	DP4, DP3, M/S
		OCT	24352		# 77	DP4, DP3, DP4
