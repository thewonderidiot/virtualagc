...
P37		TC	P20FLGON	# FIXME NEW; DOES THIS GO HERE?
...
GET.LVC		VLOAD	UNIT		# (PL 6D)   R (+29) IN MPAC, UNITIZE  UR
		...
		VXV	UNIT		# U(V*R)*U(-R), U((V*R)*(-R))
			18D
		STORE	6D		# TRANSFORMATION MATRIX IS IN 6D (+1)
		BONCLR	VLOAD
			REVFLAG
			QPRET
			0D		# DELTA V (+7) IN 0D
